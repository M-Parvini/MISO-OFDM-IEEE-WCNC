function [OFDM, Chan, BS, UE] = ...
         InitializeParams(SNRdBList, Nt, Nr, Numbits ...
         , CP_max, delay_spread, CP)
...
OFDM.bps = Numbits;             % Bits per QAM symbol
...
%%% Channel parameters %%%
Chan.delay_spread = delay_spread;    % Delay Spread of the channel
Chan.doppler = 0;
